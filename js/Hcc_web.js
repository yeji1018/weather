...
function startDeviceMotion(idx){
    ...
    switch(idx){
        ...
        case 2 : 
            ...
            else if(windowHeight >= 900) windowHeight = 900;
            
            var per = (windowHeight-600)/300;
...
function resizeHandler(){
    ...
    if(windowHeight >= 900){
        ...
        $("#video0").css({"height":windowHeight+"px", "top":"50%", "left":"50%", "margin":-windowHeight/2+"px"+" 0 0 "+((-vWidth/2)-marginNum)+"px"});
        $("#video1").css({"height":windowHeight+"px", "top":"50%", "left":"50%", "margin":-windowHeight/2+"px"+" 0 0 "+((-vWidth/2)-marginNum)+"px"});
        
        /** 섹션2 리사이즈    */
        if($(".section2 .list_img").height() > windowHeight){
            var per = (windowHeight-600)/($(".section2 .list_img").height()-600);
            $(".section2 .balloon1").css({"margin":-260-per*40+"px 0 0 "+(-415-30*per)+"px"});
            $(".section2 .device").css({"height":windowHeight+"px"});
        }else{
            $(".section2 .balloon1").css({"margin":"-300px 0 0 -445px"});
            $(".section2 .device").css({"height":$(".section2 .list_img").height()+"px"});
        }
        /** 섹션3 리사이즈    */
        if($(".section3 .list_img").height() > windowHeight){
            var per = (windowHeight-600)/($(".section3 .list_img").height()-600);
            ...
            $(".section3 .device").css({"height":windowHeight+"px"});
        }else{
            $(".section3 .indicator1").css({"margin":"-435px 0 0 -133px"});
            $(".section3 .indicator2").css({"margin":"-270px 0 0 27px"});
        ...
        /** 섹션5 리사이즈    */
        if($(".section5 .list_img").height() > windowHeight) $(".section5 .device").css({"height":windowHeight+"px"});
